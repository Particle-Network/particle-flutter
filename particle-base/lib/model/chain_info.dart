...
class ChainInfo {
  ...
  static ChainInfo Ethereum = ChainInfo(
    ...
    static ChainInfo AINNTestnet = ChainInfo(
        2648,
        'ainn',
        'evm',

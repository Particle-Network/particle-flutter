            ...
            children: [
              MobileScanner(
                ...
                onDetect: (barcode, args) {
                  setState(() {
                    if (widget.callback != null && barcode.rawValue != null) {

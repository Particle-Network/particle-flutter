...
class BiconomyFeeMode {
  ...
  BiconomyFeeMode.native(this.wholeFeeQuote) : option = 'native', feeQuote = null, tokenPaymasterAddress = null;
  ...
  BiconomyFeeMode.gasless(this.wholeFeeQuote) : option = 'gasless', feeQuote = null, tokenPaymasterAddress = null;
  ...
  BiconomyFeeMode.token(this.feeQuote, this.tokenPaymasterAddress) : option = 'token', wholeFeeQuote = null;
